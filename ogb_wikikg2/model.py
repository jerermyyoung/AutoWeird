...
class KGEModel(nn.Module):
    def __init__(self, model_name, nentity, nrelation, hidden_dim, gamma, evaluator,
                 ...
                 double_entity_embedding=False, double_relation_embedding=False, triple_relation_embedding=False, triple_entity_embedding=False, idxs = []):
        ...
        if self.sample_rels > 0:
            ...
            for i in range(len(self.triples['head'])):
